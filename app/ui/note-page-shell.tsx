        ...
        >
          ...
          >
            <span
              ...
              style={{
                left: noteFinalIcon.left,
                top: noteFinalIcon.top,
                width: noteFinalIcon.size,
                height: noteFinalIcon.size,
                backgroundColor: "var(--theme-panel-icon)",
                ...getMaskStyle("/note.svg"),
              }}
            />
            <h1
              className="absolute text-[24px] font-bold tracking-[-0.03em]"
              style={{
                left: noteFinalLabel.left,
                top: noteFinalLabel.top,
              }}
            >
              随笔
            </h1>
